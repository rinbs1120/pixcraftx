...
export const metadata = {
  title: 'About',
  description: 'Learn more about ColorForge and our mission.',
};
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              ColorForge is an AI-powered coloring page generator that helps parents, teachers,
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              creating themed worksheets, or a KDP seller building coloring books — ColorForge
              makes it fast, easy, and affordable.
            </p>

            <h2 className="font-display text-2xl mt-8 mb-4">How It Works</h2>
            <p className="text-muted-foreground leading-relaxed mb-6">
              Using advanced AI image generation, ColorForge transforms your text descriptions
            ...
            <p className="text-muted-foreground leading-relaxed">
              ColorForge is built by a small team passionate about creativity and technology.
