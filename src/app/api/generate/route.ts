...
const STYLE_PROMPTS = {
  kids: {
    prefix: "coloring book page for children, black and white line drawing only, bold thick outlines, simple shapes, clean line art, pure black ink on white paper, every element must have fully closed connected outlines with no gaps whatsoever,",
    suffix: ", strictly monochrome, absolutely no colors, no shading, no grayscale, no filled areas, no shadows, white background, large areas to color, cartoon style outline only, MANDATORY RULE: every single shape and element in this image MUST have completely closed outlines - this includes the main subject AND all background elements like trees branches leaves ground grass flowers clouds, NO line may have any gap or opening or broken stroke anywhere, every contour must form a fully sealed closed loop so that any enclosed area can be flood-filled with color without any leaking, if a line starts it must connect back to form a closed shape, zero tolerance for open paths or disconnected strokes"
  },
  mandala: {
    prefix: "coloring book page, black and white mandala pattern, pure black ink line drawing on white paper, symmetrical circular pattern, intricate line art, every element must have fully closed connected outlines with no gaps whatsoever,",
    suffix: ", strictly monochrome, absolutely no colors, no shading, no grayscale, no filled areas, white background, zen pattern, repetitive geometric shapes outline only, MANDATORY RULE: every single shape in this image MUST have completely closed outlines, NO line may have any gap or opening or broken stroke anywhere, every contour must form a fully sealed closed loop so that any enclosed area can be flood-filled with color without any leaking, zero tolerance for open paths or disconnected strokes"
  },
  detailed: {
    prefix: "coloring book page for adults, black and white line drawing only, fine lines, intricate details, pure black ink on white paper, professional illustration outline, every element must have fully closed connected outlines with no gaps whatsoever,",
    suffix: ", strictly monochrome, absolutely no colors, no shading, no grayscale, no filled areas, no shadows, white background, complex elaborate design outline only, MANDATORY RULE: every single shape and element in this image MUST have completely closed outlines - this includes the main subject AND all background elements like trees branches leaves ground grass flowers clouds, NO line may have any gap or opening or broken stroke anywhere, every contour must form a fully sealed closed loop so that any enclosed area can be flood-filled with color without any leaking, if a line starts it must connect back to form a closed shape, zero tolerance for open paths or disconnected strokes"
  }
};
